...
function NavBar() {
  ...
  const sidebar = (
    <>
      <div className="flex flex-col items-center absolute right-0 top-36 mr-10 bg-[#DCDCDC] pt-6 pr-10 pb-6 pl-10 rounded-3xl max-md:flex-row max-md:mr-0 lg:hidden">
        <button className="border-none hover:border-solid border-2 pt-2 pr-4 pb-2 pl-4 mt-4 mb-4 border-[#000000] rounded-lg">
          Home
        </button>
        <button className="border-none hover:border-solid border-2 pt-2 pr-4 pb-2 pl-4 mt-4 mb-4 border-[#000000] rounded-lg">
          About
        ...
        <button className="border border-[#228B22] bg-[#228B22] text-[#ffffff] border-4 pl-6 pr-6 pt-1 pb-1 mt-4 mr-20 mb-4 rounded-lg mr-4 font-semibold hover:text-[#000000] hover:bg-[#ffffff]">
          Sign up
        </button>
        <button className="border border-[#228B22] text-[#000000] bg-[#ffffff] border-4 pl-6 pr-6 pt-1 pb-1 mt-4 mr-20 mb-4 rounded-lg mr-4 font-semibold hover:text-[#ffffff] hover:bg-[#228B22]">
          Log in
        </button>
      </div>
    </>
